...
def change_assignment_report(student_id: str, assignment_id: str, question_id: str, query_type: str, query: str):
    query = """
    ...
    MERGE (s)-[:REPORTED]->(ar:Assignment_Report {assignment_id: $assignment_id})-[:CONTAINS]->(qr:Question_Report {query_type: $query_type, query: $query})
